      ...
      attributes: [
        ...
        { name: 'Protection' },
        {
          ...
          children: [
            {
              name: 'Border',
              properties: [{ name: 'Position', value: 'Top' }].concat(
                borderProperties,
              ),
            },
            {
              name: 'Border',
              properties: [{ name: 'Position', value: 'Bottom' }].concat(
                borderProperties,
              ),
            },
            {
              name: 'Border',
              properties: [{ name: 'Position', value: 'Left' }].concat(
                borderProperties,
              ),
            },
            {
              name: 'Border',
              properties: [{ name: 'Position', value: 'Right' }].concat(
                borderProperties,
              ),
            },
          ],
  ...
  addStripedStyles: function () {
    ...
    Ext.each(
      ...
      function (parentStyle) {
        this.addChildNumberFormatStyle(
          parentStyle,
          parentStyle + 'date',
          '[ENG][$-409]dd-mmm-yyyy;@',
        )
