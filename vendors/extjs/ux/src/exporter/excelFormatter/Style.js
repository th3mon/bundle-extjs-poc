...
Ext.define('Ext.ux.exporter.excelFormatter.Style', {
  constructor: function (config) {
    ...
    Ext.ux.exporter.excelFormatter.Style.superclass.constructor.apply(
      this,
      arguments,
    )
      ...
      function (attr, index) {
        ...
        Ext.each(
          ...
          function (child, childIndex) {
            this.attributes[index].children[childIndex].propertiesString =
              this.buildPropertyString(child)
          },
          this,
        )
      },
  ...
  buildPropertyString: function (attribute) {
    ...
    Ext.each(
      ...
      function (property) {
        propertiesString += Ext.String.format(
          'ss:{0}="{1}" ',
          property.name,
          property.value,
        )
