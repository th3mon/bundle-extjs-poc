...
Ext.define("Ext.ux.highchart.HighStock", {
  ...
  addSeries : function(series, append) {
    ...
    for(var i = 0; i < series.length; i++) {
      ...
      var cls = "Ext.ux.highchart.HighStockSerie";
  ...
  removeAllSeries : function() {
  	var sc = this.chart.series.length;
    for(var i = 0; i < sc; i++) {
      this.removeSerie(0);
    }
  },
  ...
  afterRender : function() {
    ...
    Ext.ux.highchart.HighStock.superclass.afterRender.call(this);
  ...
  draw : function() {
    ...
    if(this.chart && this.rendered) {
      if(this.resizable) {
        ...
        var chartEngine = this.chartConfig.engine || 'chart';
        this.chart = Highcharts[chartEngine](this.chartConfig);
  ...
  //private
  onResize : function() {
  	Ext.ux.highchart.HighStock.superclass.onResize.call(this);
    this.update();
  },
  // private
 ...
 * @constructor
 */
Ext.ux.highchart.HighStock.Series = function () {
